...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { clients_id: @dog.clients_id, dob: @dog.dob, name: @dog.name, walks: @dog.walks } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { clients_id: @dog.clients_id, dob: @dog.dob, name: @dog.name, walks: @dog.walks } }
